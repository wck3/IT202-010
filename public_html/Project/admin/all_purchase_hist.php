...
//echo $col ." ";
//allowed list
if (!in_array($col, ["money_recieved", "name", "o.created","username" ,""])) {
...
if ($user_id > 0) {
    ...
    //big big query
    $base_query= "SELECT u.username, o.id as order_id, si.name, i.item_id, i.quantity, CAST(( i.unit_price * quantity) / 100.00 AS decimal(18,2)) as subtotal, CAST(o.money_recieved / 100.00 AS decimal(18,2)) AS order_total , o.created as date, o.payment_method,o.address,
    ...
    $total_query = "SELECT count(1) as total FROM Order_Items i JOIN Shop_Orders o on i.order_id = o.id JOIN Shop_Items si ON si.id = i.item_id JOIN Users u on u.id = o.user_id";
