...
function getTotal($arr) {
    ...
    $total = 0.00;
    //TODO do adding here
    foreach($arr as &$num){          //loop through array and add values to total variable
        $total+=$num;
    } 
    //TODO do rounding stuff here
    $total=round($total, 2);         //round to two decimals
    $total=number_format($total, 2); //format decimals to add trailing zero
